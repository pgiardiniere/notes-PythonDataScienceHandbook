...
# NOTE: The sklearn.gaussian_process package no longer has GaussianProcess.
#       It contains GaussianProcessRegressor and GaussianProcessClassifier.
#       Neither of which share kwargs we're specifying.
